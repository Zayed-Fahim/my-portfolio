...
const AllProjects = ({ projects }) => {
  return (
    <div className="bg-no-repeat object-contain lg:object-cover mt-[63px] bg-center bg-fixed bg-black bg-opacity-80 min-h-full lg:w-[100%] bg-[url('/src/assets/background/project-background.gif')]">
        ...
        <div class="h-full z-0 scroll-smooth">
          <div class="container mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 h-full pb-10 lg:pb-20">
              ...
              <Link class="border-r border-gray-300 mx-3 lg:pl-16 lg:mt-[80px]">
              ...
              <Link class="border-r border-gray-300 mx-3 lg:pl-16">
              ...
              <Link class="border-r border-gray-300 mx-3 lg:mt-[62px] lg:pl-16">
