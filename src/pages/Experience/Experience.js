  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto">
        <div className="flex-wrap flex lg:flex-nowrap justify-center pt-10 lg:pt-12 gap-10">
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[150px] h-[150px] lg:w-[225px] lg:h-[225px] flex flex-col justify-center items-center lg:gap-[34px]">
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center gap-10 pb-10 lg:pb-12 mt-10">
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[150px] h-[150px] lg:w-[225px] lg:h-[225px] flex flex-col justify-center items-center lg:gap-[34px]">
