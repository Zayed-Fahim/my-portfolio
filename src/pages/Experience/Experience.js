    ...
    <div className="bg-gradient-to-r from-[#1C1C1C] to-[#2C2C2C] shadow-md">
      ...
      <div className="container mx-auto">
        <div className="flex-wrap flex lg:flex-nowrap justify-center pt-10 lg:pt-12 gap-10">
          <div className="bg-[#242526] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[150px] h-[150px] lg:w-[225px] lg:h-[225px] flex flex-col justify-center items-center lg:gap-[34px]">
