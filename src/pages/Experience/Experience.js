    ...
    <div className="bg-gradient-to-r from-[#414141] to-[#2D2D2D]">
      ...
      <div className="container mx-auto">
        <div className="flex justify-center pt-16 gap-10">
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <FaHtml5 className="h-[75px] w-[75px] text-[#00C4F0]"></FaHtml5>
            <h1 className="text-white text-2xl">HTML5</h1>
          </div>
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <FaCss3Alt className="h-[75px] w-[75px] text-[#00C4F0]"></FaCss3Alt>
            <h1 className="text-white text-2xl">CSS3</h1>
          </div>
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <SiJavascript className="h-[75px] w-[75px] text-[#00C4F0]"></SiJavascript>
            <h1 className="text-white text-2xl">Java Script</h1>
          </div>
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <FaReact className="h-[75px] w-[75px] text-[#00C4F0]"></FaReact>
            <h1 className="text-white text-2xl">React</h1>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-10 mt-10">
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            ...
            <h1 className="text-white text-2xl">mongo DB</h1>
          </div>
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
        ...
        <div className="flex justify-center gap-10 pb-32 mt-10">
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <SiFirebase className="h-[75px] w-[75px] text-[#00C4F0]"></SiFirebase>
            <h1 className="text-white text-2xl">Firebase</h1>
          </div>
          <div className="bg-[#2A2A2A] rounded-[29px] shadow-[0_4px_6px_rgba(0,0,0,0.47)] w-[230px] h-[230px] flex flex-col justify-center items-center gap-[34px]">
            <SiVercel className="h-[75px] w-[75px] text-[#00C4F0]"></SiVercel>
            <h1 className="text-white text-2xl">Vercel</h1>
          </div>
        </div>
      </div>
    </div>
