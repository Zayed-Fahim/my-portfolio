...
const About = () => {
  return (
    <div
      className="bg-gradient-to-r from-[#2C2C2C] to-[#1C1C1C] max-h-[128vh]  lg:mb-auto py-8 lg:py-0 lg:max-h-[1100px]"
      id="about-me"
    >
      <div className="container mx-auto invisible lg:visible">
        <div className="lg:w-[792px] lg:h-[792px] border-solid border-[89px] border-[#E4E4E4] drop-shadow-[0_4px_70px_rgba(255,255,255,0.25)] rounded-[50%] relative top-[125px] mb- left-24">
      ...
      <div className="relative lg:max-w-[496px] lg:h-[822px] bg-[#2C2C2C] rounded-[14px] lg:bottom-[665px] lg:left-[740px] bottom-[700px] mx-5 z-[1] lg:mx-0">
        <div className="relative left-16 bottom-7">
