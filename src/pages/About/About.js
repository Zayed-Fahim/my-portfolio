...
const About = () => {
  return (
    <div
      className="bg-gradient-to-r from-[#2C2C2C] to-[#1C1C1C] overflow-hidden h-[1100px] lg:h-[1230px]"
      id="about-me"
    >
      ...
      <div className="relative left-[95px] lg:left-[855px] top-[-1590px] lg:top-[-1500px] z-[1]">
      ...
      <div className="lg:w-[496px] lg:h-[822px] m-5 lg:m-0 bg-[#2C2C2C] rounded-[14px] relative lg:left-[800px] lg:top-[-1523px] top-[-1563px]">
        <p className="p-4 lg:p-[55px] text-xl text-[#FFFFFF]">
      ...
      <div className="invisible lg:visible w-[330px] p-6 bg-[#2C2C2C] rounded-[14px] relative left-[510px] top-[-2390px]">
        <img
      ...
      <div className="invisible lg:visible w-[330px] p-6 bg-[#2C2C2C] rounded-[14px] relative left-[510px] top-[-1980px]">
        <img
          className="w-[272px] shadow-[0_0_0_6px_#686868]"
          src={about1}
          alt="me-2"
      ...
      <div className="invisible lg:visible w-[330px] h-[485px] p-6 bg-[#2C2C2C] rounded-[14px] relative left-[1260px] top-[-2680px]">
        <img
